...
while finished == False: #while game is running
	...
	#print(pressed_keys[pygame.K_UP]) #So when you do pressed_keys[273] ,it shows that the Up arrow key is detected and prints a value of 1 when you hit the Up arrow key
